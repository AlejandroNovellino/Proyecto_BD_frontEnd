...
export const TipoUsuarioCreate = () => {
	// use context
	...
	const handleCreate = async values => {
		...
		// try to create
		let tipoUsuario = await actions.createTipoUsuario(params);
		if (!tipoUsuario) {
			...
			// show the alert
			setErrorMessage("Error en la creacion del tipo de usuario");
			setAlertShow(true);
			return false;
		} else {
		...
		<>
			...
			<Modal
				...
				<Modal.Header closeButton>
					<Modal.Title>Tipo usuario creado</Modal.Title>
				</Modal.Header>
				<Modal.Body>Se ha creado el tipo de usuario exitosamente</Modal.Body>
			</Modal>
					...
					<Col xs={9}>
						<Card bg={"dark"} text={"white"} className="">
							<Card.Header className="fs-5 fw-bold">
								Ingrese los datos del tipo de usuario a registrar:
							</Card.Header>
